...
//   // Updated rating fields to match ReviewService expectations
//   @Prop({ default: 0, min: 0, max: 5 })
//   rating: number // This should be 'rating' not 'averageRating'

//   @Prop({ default: 0 })
//   reviewCount: number

//   // Add this field to track approved reviews specifically
//   @Prop({ default: 0 })
...
//   // REMOVED: reviews array - we're using separate Review collection
//   // Reviews will be accessed via populate or separate queries
