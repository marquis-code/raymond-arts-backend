...
//     // if (updateSaleDto.date) {
//     //   updateSaleDto["date"] = new Date(updateSaleDto.date)
//     // }
//     if (updateSaleDto.date) {
//       updateSaleDto.date = new Date(updateSaleDto.date).toISOString() as any;
//     }

//     const updatedSale = await this.saleModel.findByIdAndUpdate(id, updateSaleDto, { new: true }).exec()
