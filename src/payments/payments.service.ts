...
// // FIXED: Import the correct PaymentStatus enum for DTO operations
// import { PaymentStatus } from "../orders/enums/payment-status.enum"
// // Import the schema PaymentStatus for order comparisons
// import { PaymentStatus as SchemaPaymentStatus } from "../orders/schemas/order.schema"
...
//     @Inject(forwardRef(() => OrdersService)) // FIXED: Use forwardRef injection
...
//     // PERMANENTLY FIXED: Check if order is already paid using schema enum
//     if (order.paymentStatus === SchemaPaymentStatus.PAID) {
...
//       // Update order payment status using the new DTO structure - FIXED
//       await this.ordersService.updatePaymentStatus(
//         order._id.toString(),
//         {
//           paymentStatus: PaymentStatus.PAID, // Now correctly typed
...
//           // FIXED: Using correct PaymentStatus enum
//           await this.ordersService.updatePaymentStatus(
//             orderId,
//             {
//               paymentStatus: PaymentStatus.PAID, // Now correctly typed
...
//         // Update order payment status - FIXED
//         if (transaction.order) {
//           await this.ordersService.updatePaymentStatus(
...
//   // Add the missing createScheduledPayment method
//   async createScheduledPayment(item: ScheduledPaymentItem, userId: string): Promise<any> {
//     try {
//       // Create a scheduled payment record
//       // This is a placeholder implementation - you might want to create a separate ScheduledPayment model
...
//       // Log the scheduled payment creation
//       await this.auditService.createAuditLog({
//         action: "CREATE_SCHEDULED_PAYMENT",
//         userId,
//         module: "PAYMENTS",
//         description: `Scheduled payment created for order ${item.order}`,
//         changes: JSON.stringify(scheduledPayment),
//       })
